            ...
            <CardHeader className="space-y-1 flex flex-col items-center">
              <div className="flex items-center gap-2 mb-2">
                <div className="relative">
                  <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-zinc-600 to-black-600 opacity-75 blur"></div>
            ...
            <CardContent>
              <Form {...form}>
                ...
                >
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-gradient-to-r text-white from-zinc-600 to-zinc-600 hover:from-zinc-500 hover:to-zinc-500 border-0"
                    disabled={isLoading}
                  >
                    {isLoading ? (
