...
export function ResumeNotFound({ className, variant = "empty" }: ResumeNotFoundProps) {
  const icons = {
  ...
  const titles = {
    ...
    search: "No matching resumes",
    error: "Couldn't load resumes",
  }

  const descriptions = {
    empty: "When you create a resume, it will appear here in your collection.",
    search: "We couldn't find any resumes matching your search criteria.",
    error: "There was a problem loading your resumes. Please try again later.",
  }
